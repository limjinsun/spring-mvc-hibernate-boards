  ...
  createClass(DateTimePicker, [{
    ...
    value: function open() {
      ...
      if (!this.value) {
        ...
        // For now this allows us to set the default time using the same
		// quantize
        // rules as setting the date explicitly. Setting this.value meets
		// setTime|Date's
        // expectation that we have a value, and `0` guarantees that we will
		// detect
        this.value = moment(0);
